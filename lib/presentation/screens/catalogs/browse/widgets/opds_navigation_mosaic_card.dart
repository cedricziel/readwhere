...
///
/// Used for OPDS navigation sections to provide a visual preview of the
/// content inside before navigating.
class OpdsNavigationMosaicCard extends StatelessWidget {
  ...
  const OpdsNavigationMosaicCard({
    super.key,
    required this.entry,
...
class OpdsNavigationMosaicTile extends StatelessWidget {
  /// The parent navigation entry.
  final OpdsEntry entry;
  ...
  const OpdsNavigationMosaicTile({
    super.key,
    required this.entry,
    required this.childCoverUrls,
    required this.onTap,
